                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ URL::to('/management-slider') }}">Tất cả slider</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ URL::to('/all-new') }}">Tất cả tức</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('/management-order') }}">Quản lý đơn hàng</a></li>
                            </ul>
                        </li>       
                        <li class="sub-menu">
                            <a href="javascript:;">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('/show-user') }}">Quản lý người dùng</a></li>
                            </ul>
                        </li>      
                    </ul>
                </div>
        ...
        <section id="main-content">
            ...
            <div class="footer">
                <div class="wthree-copyright">
                    <p>© 2021 Admin Page. All rights reserved | Design by <a href="https://www.facebook.com/profile.php?id=100009223112624">Hiệp Phan</a></p>
                </div>
            </div>
            <!-- / footer -->
        </section>
